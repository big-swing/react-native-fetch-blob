 ...
 * Set the app-wide salt to be used in crypto when encrypting downloaded files
 * @param   {string} salt String that will be used to salt the encryption
 * @return  {void}
 */
    ...
    this.blob = (): Promise<Blob> => {
      ...
      return new Promise((resolve, reject) => {
        switch (this.type) {
          ...
          default:
            polyfill.Blob
              .build(this.data, { type: "text/plain" })
              .then(resolve);
            break;
        }
      });
